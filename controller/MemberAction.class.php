...
class MemberAction extends Action{
	...
	public function delCollect(){
		if(isset($_GET['id'])){
			$this->_collect->delCollect()?$this->_redirect->succ('?a=member&m=collect') : $this->_redirect->error('取消收藏失败！');
		}
	}
	...
	public function cancel(){
		$this->_order->cancel()?$this->_redirect->succ(Tool::getPrevPage()) : $this->_redirect->error('订单取消失败！');
	}

	public function refund(){
		$this->_order->refund()?$this->_redirect->succ(Tool::getPrevPage()) : $this->_redirect->error('申请退款失败！');
	}
