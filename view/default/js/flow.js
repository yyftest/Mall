window.onload = function () {
	...
	for (var i = 0; i < fm.delivery_radio.length; i ++) {
		if (fm.delivery_radio[i].checked == true) {
			...
			document.getElementById('price3').innerHTML = total.getElementsByTagName('strong')[1].innerHTML = document.getElementById('delivery').innerHTML = parseFloat(fm.delivery_radio[i].value) + (parseFloat(fm.delivery_radio[i].getAttribute('weight')) - 10) * parseFloat(fm.delivery_radio[i].getAttribute('add'));
...
function changeDelivery(delivery) {
	...
	document.getElementById('price3').innerHTML = total.getElementsByTagName('strong')[1].innerHTML = document.getElementById('delivery').innerHTML = parseFloat(delivery.value) + (parseFloat(delivery.getAttribute('weight')) - 10) * parseFloat(delivery.getAttribute('add'));
