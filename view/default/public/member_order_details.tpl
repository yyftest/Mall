...
<div id="main">
	...
	</td><td class="price">{$value.price_sale}/元</td><td>{$value.num}</td><td class="price">{$value.price_sale*$value.num}/元</td><td>
	...
	<p style="text-align:center;margin-bottom: 50px;font-size: 15px;"><a href="{$prev}">[返回]</a></p>
</div>
