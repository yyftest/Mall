<?php /* Smarty version 2.6.26, created on 2018-04-04 18:20:47
...
<table id="cart" cellspacing="1">
	...
	<tr><th>编号</th><th>名称</th><th>属性</th><th class="th">售价</th><th class="th">数量</th><th class="th">总重量</th><th class="th">小计</th></tr>
...
<table id="cart" cellspacing="1">
	...
	<tr><td><input type="radio" name="pay_radio" title="支付宝" value="0" checked="checked" onclick="changePay(this);" /></td><td>支付宝</td><td>通过支付宝在线支付</td><td>0/元</td></tr>
	<tr><td><input type="radio" name="pay_radio" title="银行转账/汇款" value="1.8" onclick="changePay(this);" /></td><td>银行转账/汇款</td><td>通过转账汇款，联系客服，提供汇款清单和商品订单号</td><td>1.8/元</td></tr>
	<tr><td><input type="radio" name="pay_radio" title="货到付款" value="2" onclick="changePay(this);" /></td><td>货到付款</td><td>通过配送人员，送货上门，收取费用</td><td>2/元</td></tr>
</table>
...
<p>您总共要支付的金额为：<strong class="price" id="price"></strong>/元</p>

<input type="hidden" name="user" value="<?php echo $_COOKIE['user']; ?>
" />
<input type="hidden" name="name" value="李炎恢" />
<input type="hidden" name="email" value="2875541071@qq.com" />
<input type="hidden" name="address" value="湖南长沙旺旺中路" />
<input type="hidden" name="code" value="422100" />
<input type="hidden" name="tel" value="18229919139" />
<input type="hidden" name="buildings" value="旺旺集团旁边" />
