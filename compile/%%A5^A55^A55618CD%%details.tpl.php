<?php /* Smarty version 2.6.26, created on 2018-04-06 21:23:12
         compiled from default/public/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'default/public/details.tpl', 153, false),)), $this); ?>
...
';</script>
		<?php echo '
		<dd>分享至：<a href="javascript:void((function(s,d,e){
			try{}catch(e){}
			var f=\'http://service.weibo.com/share/share.php?\',
			u=d.location.href,
			p=[\'url=\',e(u),\'&title=\',e(d.title),\'&pic=\',e(thumbnail),\'&appkey=\'].join(\'\');
			function a(){
			...
			}})(screen,document,encodeURIComponent));">新浪微博</a>  
...
" target="_blank"><img src="view/default/images/collect.gif" alt="收藏" title="收藏" /></a></dd>
	</dl>
	</form>
	<div class="content">
		<a name="commend"></a>
...
</td><td style="text-align:center;line-height:180%;" title="<?php echo $this->_tpl_vars['value']->name; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['value']->name)) ? $this->_run_mod_handler('truncate', true, $_tmp, 50) : smarty_modifier_truncate($_tmp, 50)); ?>
