<?php /* Smarty version 2.6.26, created on 2018-04-04 17:01:43
...
?>
	...
	</td><td class="weight"><?php echo $this->_tpl_vars['value']['weight']; ?>
/kg</td><td class="price"><?php echo $this->_tpl_vars['value']['price_sale']; ?>
/元</td><td><input type="text" name="num" onblur="changeNum(<?php echo $this->_tpl_vars['value']['id']; ?>
