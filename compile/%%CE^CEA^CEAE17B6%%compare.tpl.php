<?php /* Smarty version 2.6.26, created on 2018-04-06 19:40:36
...
" target="_blank"><?php echo $this->_tpl_vars['value']->name; ?>
			...
			<dd>品牌：<?php echo $this->_tpl_vars['value']->sn; ?>
</dd>
			<dd>属性：<?php echo $this->_tpl_vars['value']->sn; ?>
</dd>
			<dd>重量：<?php echo $this->_tpl_vars['value']->sn; ?>
kg</dd>
...
人评价</a></dd>
			<dd>销量：<span class="green">(销售<strong><?php echo $this->_tpl_vars['value']->sales; ?>
...
">删除此对比商品</a></dd>
		...
		<div id="page"><a href="?a=compare&m=clearCompare" style="padding: 8px; font-size: 12px;">清空对比商品</a></div>
		<?php endif; ?>
	</div>
</div>
